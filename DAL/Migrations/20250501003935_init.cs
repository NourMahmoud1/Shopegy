    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productreivew", x => x.ID);
                    table.ForeignKey(
                        name: "FK_productreivew_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_productreivew_Users_UserID",
                        column: x => x.UserID,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shipping_ShippingAddress_ShippingAddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_productreivew_ProductId",
                table: "productreivew",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_productreivew_UserID",
                table: "productreivew",
                column: "UserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipping_ShippingAddressId",
                table: "Shipping",
